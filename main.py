...
class MainWindow(Gtk.ApplicationWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.rvl_side_pane.set_transition_duration(300)
        ...
        self.lbl_pane_tr.set_halign(Gtk.Align.CENTER)
        self.lbl_pane_tr.set_valign(Gtk.Align.CENTER)
        ...
        self.lbl_pane_bl.set_halign(Gtk.Align.CENTER)
        self.lbl_pane_bl.set_valign(Gtk.Align.CENTER)
        ...
        self.lbl_pane_br.set_halign(Gtk.Align.CENTER)
        self.lbl_pane_br.set_valign(Gtk.Align.CENTER)
        ...
        self.frm_btm_start_child.set_child(self.lbl_pane_bl)
        self.frm_btm_end_child = Gtk.Frame()
        self.frm_btm_end_child.add_css_class("frame")
        self.frm_btm_end_child.set_child(self.lbl_pane_br)
        # panded top
